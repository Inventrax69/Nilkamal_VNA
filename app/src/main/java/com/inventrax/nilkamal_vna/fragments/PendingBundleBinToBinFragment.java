...
public class PendingBundleBinToBinFragment extends Fragment implements View.OnClickListener {

    private static final String classCode = "API_FRAG_PENDING_BUNDLE_BIN TO BIN";
    ...
    public void loadFormControls() {
        ...
        // To get Pending Bundle Bin to Bin Transfers List
    ...
    public void goBack(){
        ...
        BundleBintoBinFragment bundleBintoBinFragment = new BundleBintoBinFragment();
        bundleBintoBinFragment.setArguments(bundle);
        FragmentUtils.replaceFragmentWithBackStack(getActivity(), R.id.container_body, bundleBintoBinFragment);
